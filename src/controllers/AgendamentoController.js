...
class AgendamentoController {
    ...
    async incluirAgendamento(req, res) {
        ...
        let agendamento = new Agendamento(null, req.body.dataHoraAgendamento, atendimento, usuario);
    ...
    async alterarAgendamento(req, res) {
        ...
        let agendamento = new Agendamento(req.params.id, req.body.req.body.dataHoraAgendamento, atendimento, usuario);
